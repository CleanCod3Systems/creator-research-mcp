...
This file exists so any AI agent (Claude Code or otherwise) working on this repo stays on
course. It was written after a real incident: a large, well-engineered feature set (Instagram
OAuth via Meta Graph API, a shared "auth broker" service, SponsorBlock, consolidated research
tools) was built in one session without checking it against these principles, and had to be
fully reverted because it contradicted #2 below. Check new work against this file *before*
